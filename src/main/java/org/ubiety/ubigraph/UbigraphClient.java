...
{
  try {
    Object[] params = new Object[]{vertexId};
...
{
  try {
    Object[] params = new Object[]{edgeId, i,
            j};
...
{
  try {
    Object[] params = new Object[]{edgeId};
...
{
  try {
    Object[] params = new Object[]{vertexId, attribute,
      value };
...
{
  try {
    Object[] params = new Object[]{parent_styleId};
...
{
  try {
    Object[] params = new Object[]{styleId, attribute, value};
...
{
  try {
    Object[] params = new Object[]{vertexId, styleId};
...
{     
  try {
    Object[] params = new Object[]{edgeId, styleId};
